---
title: Deriving logistic population growth functions
author: James Maino
date: '2018-11-06'
...
When $N$ is small the growth rate is approximately $rN$ but as $N \to K$ the growth rate scales to zero. Thus $K$ can be thought of as the carrying capacity of the population.  Before we solve this equation with maths (analytically), let's solve it using computers (numerically) for $r=0.3$, and $K=100$ assuming the population started with just 2 individuals. 
