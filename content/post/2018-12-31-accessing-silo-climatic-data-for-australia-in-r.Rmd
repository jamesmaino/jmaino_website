...
EDIT (24/06/2019): After trying to access SILO data in another project I found that their site's security protocols have lapsed. Hopefully it is rectified soon, but to bypass this, you need to pass the argument `config = httr::config(ssl_verifypeer = FALSE)` everything the site is queried with `GET()`.
